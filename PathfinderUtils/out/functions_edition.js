			...
			<div><span id="zo-warning" style="color:#FF0000; font-weight: bold; display: none;">/!\\ pas de prefix zone pour cette aventure</span>
				<form action="/" method="post" id="zo-form">
					...
					<select class="custom-select mb-2 mr-sm-2 mb-sm-0" id="zo-shape" name="zo-shape" style="width:50%;"><option hidden disabled value="">Forme *</option>
						<optgroup label="Simple"><option value="at:beer">Bi&egrave;re</option><option value="at:duck">Canard</option><option value="at:fight">Combat</option><option value="at:skull">Cr&acirc;ne</option><option value="at:star">Etoile</option>><option value="at:loupe">Loupe</option><option value="at:meet">Rencontre</option></optgroup>
